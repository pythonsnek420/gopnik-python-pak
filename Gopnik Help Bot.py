...
8. Why did you say "branch/folder" in question 3?
""")
...
(it's in the same branch/folder as this bot)
and it'll do the work for you.""")
    ...
    if question == ("8")
        print("""People get this bot from both github and cd's,
so i wanted to relate to both groups of people""")
